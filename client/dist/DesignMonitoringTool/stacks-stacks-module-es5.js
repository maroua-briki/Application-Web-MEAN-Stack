...
var AddStackComponent = /** @class */ (function () {
    function AddStackComponent() {
    }
    AddStackComponent.prototype.ngOnInit = function () {
    };
...
var StacksListComponent = /** @class */ (function () {
    function StacksListComponent() {
    ...
    StacksListComponent.prototype.ngOnInit = function () {
    };
...
var StacksRoutingModule = /** @class */ (function () {
    function StacksRoutingModule() {
    }
...
var StacksComponent = /** @class */ (function () {
    function StacksComponent(dialog) {
        this.dialog = dialog;
    }
    StacksComponent.prototype.ngOnInit = function () {
    };
    StacksComponent.prototype.openDialog = function () {
        var dialogRef = this.dialog.open(_add_stack_add_stack_component__WEBPACK_IMPORTED_MODULE_3__["AddStackComponent"], {
            width: '1300px', disableClose: true
        });
    };
    StacksComponent.ctorParameters = function () { return [
...
var StacksModule = /** @class */ (function () {
...
//# sourceMappingURL=stacks-stacks-module-es5.js.map