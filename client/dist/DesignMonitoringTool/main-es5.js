...
var appRoutes = [
    { path: 'home', loadChildren: function () { return Promise.all(/*! import() | layout-layout-module */[__webpack_require__.e("default~layout-layout-module~projects-projects-module~stacks-stacks-module"), __webpack_require__.e("default~layout-layout-module~projects-projects-module"), __webpack_require__.e("layout-layout-module")]).then(__webpack_require__.bind(null, /*! ./layout/layout.module */ "./src/app/layout/layout.module.ts")).then(function (m) { return m.LayoutModule; }); }, canActivate: [_shared_authGuard_auth_guard__WEBPACK_IMPORTED_MODULE_5__["AuthGuard"]] },
    { path: 'projects', loadChildren: function () { return Promise.all(/*! import() | projects-projects-module */[__webpack_require__.e("default~layout-layout-module~projects-projects-module~stacks-stacks-module"), __webpack_require__.e("default~layout-layout-module~projects-projects-module")]).then(__webpack_require__.bind(null, /*! ./projects/projects.module */ "./src/app/projects/projects.module.ts")).then(function (m) { return m.ProjectsModule; }); } },
    { path: 'stacks', loadChildren: function () { return Promise.all(/*! import() | stacks-stacks-module */[__webpack_require__.e("default~layout-layout-module~projects-projects-module~stacks-stacks-module"), __webpack_require__.e("stacks-stacks-module")]).then(__webpack_require__.bind(null, /*! ./stacks/stacks.module */ "./src/app/stacks/stacks.module.ts")).then(function (m) { return m.StacksModule; }); } },
...
var LoginComponent = /** @class */ (function () {
    function LoginComponent(_router, _formBilder, _userService) {
    ...
    LoginComponent.prototype.onSubmit = function (email, password) {
        var _this = this;
        this.submitted = true;
        this._userService.login(email, password).subscribe(function (res) {
            console.log('j ai depassé subscribe');
...
var RegisterComponent = /** @class */ (function () {
    function RegisterComponent(_userService, _router, _formBilder) {
        this._userService = _userService;
        this._router = _router;
        this._formBilder = _formBilder;
        this.submitted = false;
    ...
    RegisterComponent.prototype.onSubmit = function (fullName, email, password) {
        var _this = this;
        console.log(fullName);
        this.submitted = true;
        this._userService.postUser(fullName, email, password).subscribe(function (res) {
            // console.log('j ai depassé subscribe');
            console.log(res);
            ...
            if (err.status === 422) {
                ...
                console.log('erreur: ' + _this.serverErrorMessages);
...
var UserService = /** @class */ (function () {
    ...
    UserService.prototype.postUser = function (fullName, email, password) {
        var user = {
            fullName: fullName,
            email: email,
            password: password,
